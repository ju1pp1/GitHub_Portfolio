...
private:
    ...
    //vector for getting stuff in order projects were added.
    std::vector<Project*> created_projects_;
    std::map<std::string, Project*> current_projects_;
    std::map<std::string, Project*> alltime_projects_;

    std::map<Employee*, std::vector<Project*>> project_staff_;
};
