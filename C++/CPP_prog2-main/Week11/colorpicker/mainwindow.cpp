    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(ui->spinBoxRed, qOverload<int>(&QSpinBox::valueChanged), ui->horizontalSliderRed, &QSlider::setValue);
    connect(ui->spinBoxGreen, qOverload<int>(&QSpinBox::valueChanged), ui->horizontalSliderGreen, &QSlider::setValue);
    connect(ui->spinBoxBlue, qOverload<int>(&QSpinBox::valueChanged), ui->horizontalSliderBlue, &QSlider::setValue);
