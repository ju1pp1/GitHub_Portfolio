        ...
        if(command == "U" or command == "u") {
            ...
            if(student_numbers.find(student_number) != student_numbers.end())
            {
                ...
                if(is_valid_phone_number(new_phone_number))
                    //Update the phone number in the in-memory structure
                {
                    student_numbers[student_number]->phone_number = new_phone_number;
                    //cout << "Phone number updated successfully." << endl;
                    cout << endl;

                    //Update data in the file
                    ofstream file_object(file_name, ios::out | ios::trunc);
                    if(!file_object)
                    {
                    ...
                    //cout << "Invalid phone number. No changes made." << endl;
